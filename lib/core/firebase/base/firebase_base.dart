...
import '../firestore/manager/post_manager/like_manager.dart';
import '../firestore/manager/post_manager/post_and_comment_deleter.dart';
import '../firestore/manager/post_manager/post_manager.dart';
import '../firestore/manager/post_manager/save_manager.dart';
...
abstract class FirebaseBase {
  ...
  FirebasePostManager get firebasePostManager => FirebasePostManager.instance;
  PostLikeManager get postLikeManager => PostLikeManager.instance;
  PostSaveManager get postSaveManager => PostSaveManager.instance;
  PostAndCommentDeleter get postDeleter => PostAndCommentDeleter.instance;
